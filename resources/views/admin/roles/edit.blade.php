<x-admin-layout>
    ...
    <div class="mt-12 max-w-6xl mx-auto bg-slate-50 p-4 rounded">
        ...
        <div class="mx-auto mt-12 max-w-md rounded bg-gray-100 p-6">
            <form action="{{ route('admin.roles.permissions', $role->id) }}" method="POST" class="space-y-5">
                @csrf
                <div>
                ...
                <button type="submit"
                    class="mt-10 w-full bg-indigo-400 py-3 font-medium uppercase text-white hover:bg-indigo-600 hover:shadow-none focus:outline-none">Assign Permissions</button>
            </form>
        </div>
